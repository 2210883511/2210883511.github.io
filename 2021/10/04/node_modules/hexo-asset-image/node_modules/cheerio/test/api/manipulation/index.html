...
<meta property="og:url" content="http://example.com/2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/index.html">
...
<meta property="article:published_time" content="2021-10-04T04:28:58.942Z">
<meta property="article:modified_time" content="2015-01-24T21:47:06.000Z">
<meta property="article:author" content="李二狗">
<meta name="twitter:card" content="summary">

<link rel="canonical" href="http://example.com/2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/">
...
<div id="search-result">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-block" lang="zh-CN">
    <link itemprop="mainEntityOfPage" href="http://example.com/2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/">
  ...
  <span class="post-meta-item">
    ...
    <a title="disqus" href="/2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/#disqus_thread" itemprop="discussionUrl">
      <span class="post-comments-count disqus-comment-count" data-disqus-identifier="2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/" itemprop="commentCount"></span>
    </a>
  </span>
...
describe('$(...)', function() {
  ...
  describe('.text', function() {
    ...
    <a href="/2021/10/04/node_modules/cheerio/test/api/forms/" rel="prev" title="">
      <i class="fa fa-chevron-left"></i> 
    </a></div>
      <div class="post-nav-item">
    <a href="/2021/10/04/node_modules/cheerio/test/api/manipulation/" rel="next" title="">
  ...
  <aside class="sidebar">
    <div class="sidebar-inner">
      ...
      <div class="post-toc-wrap sidebar-panel">
          <div class="post-toc motion-element"><ol class="nav"><li class="nav-item nav-level-2"><a class="nav-link"><span class="nav-number">1.</span> <span class="nav-text">hi there</span></a></li><li class="nav-item nav-level-2"><a class="nav-link"><span class="nav-number">2.</span> <span class="nav-text">hi </span></a></li><li class="nav-item nav-level-2"><a class="nav-link"><span class="nav-number">3.</span> <span class="nav-text">hi there</span></a></li><li class="nav-item nav-level-2"><a class="nav-link"><span class="nav-number">4.</span> <span class="nav-text">hi here</span></a></li><li class="nav-item nav-level-2"><a class="nav-link"><span class="nav-number">5.</span> <span class="nav-text">hi there</span></a></li><li class="nav-item nav-level-2"><a class="nav-link"><span class="nav-number">6.</span> <span class="nav-text">hi here</span></a></li></ol></div>
      </div>
      <!--/noindex-->
...
<script>
  var disqus_config = function() {
    this.page.url = "http://example.com/2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/";
    this.page.identifier = "2021/10/04/node_modules/hexo-asset-image/node_modules/cheerio/test/api/manipulation/";
    this.page.title = "";
    };
